...
async def start(event):
    ...
    collection.update_one({"user_id": user_id}, {"$set": {"user_id": user_id}}, upsert=True)
    buttons = [
        [Button.url("Join Channel", url="https://t.me/neetumamvoca")],
        [Button.url("Contact Me", url="https://t.me/RAJPUT681830")],
    ]
...
async def plan_command(event):
    ...
    buttons = [
        [Button.url("Send Gift Card Code", url="https://t.me/RAJPUT681830")]
    ]
...
async def term_command(event):
    # Creating inline keyboard with buttons
    buttons = [
        [Button.url("Query?", url="https://t.me/RAJPUT681830"),
         Button.url("Channel", url="https://t.me/neetumamvoca")]
    ]
...
REPO_URL = "https://github.com/hyh/Save-Restricted-Content-Bot-Repo"
...
async def youtube_dl_command(_, message):
    ...
    if len(message.command) > 1:
        ...
        try:
            ...
            caption = f"{video_info['title']}\n\n__**Powered by [Advance Content Saver Bot](https://t.me/SaverestricsjdhvdhBot)**__"  # Set caption to the title of the video
